      ...
      children: [
            ...
            children: [
              ...
              AnimatedAlign(
                ...
                alignment: _exampleVisible
                    ? const Alignment(.48, .60)
                    : const Alignment(0, .60),
                child: Transform.translate(
                  offset: Offset(0, compact ? 20 : 28),
                  child: SizedBox(
        ...
        Row(
          ...
          children: [
            ...
            SizedBox(width: compact ? 8 : AppSpacing.md),
            LessonActionButton(
              label: 'فهمت!',
      ...
      child: Padding(
        ...
        child: FittedBox(
          ...
          child: Text(
            ...
            style: _style(compact ? 126 : 166).copyWith(height: 1.35),
            strutStyle: StrutStyle(
              fontFamily: 'Tajawal',
              fontSize: compact ? 126 : 166,
              height: 1.35,
