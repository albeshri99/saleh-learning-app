                ...
                builder: (context, constraints) {
                  if (constraints.maxWidth < 1100 ||
                    ...
                    return _CompactLesson(
                      ...
                      api: api,
                      onExit: () => context.go('/'),
                      onNext: controller.completeScene,
...
class _CompactTopBar extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final progress = (state.sceneIndex + 1) / state.lesson.scenes.length;
                    ...
                    Expanded(
                      child: ClipRRect(
                        ...
                        child: LinearProgressIndicator(
                          ...
                          backgroundColor: const Color(0xFFE9DFD1),
                        ),
                      ),
                    ),
                    const SizedBox(width: 7),
                    Text(
                        '${state.sceneIndex + 1}/${state.lesson.scenes.length}',
