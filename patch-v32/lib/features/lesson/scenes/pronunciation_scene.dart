  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        Expanded(
          child: Padding(
            padding: EdgeInsets.only(top: compact ? 2 : AppSpacing.sm),
            child: Align(
              // كان الحرف قريبًا من عنوان «تدريب النطق». نضع مركزه
              // البصري في منتصف المساحة المتاحة فوق الميكروفون.
