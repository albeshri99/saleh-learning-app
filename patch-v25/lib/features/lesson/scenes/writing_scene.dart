              ...
              children: [
                if (_showDemo)
                  ...
                  Padding(
                    padding: const EdgeInsets.all(2),
                    child: _attemptDone
                        ? _CompletedLetter(letter: letter, strokes: _strokes)
                        : GuidedTracingCanvas(
          ...
          children: [
            if (!_guided) ...[
              ...
              LessonActionButton(
                ...
                onPressed:
                    _hasFreeInk ? _finishAttempt : widget.api.completeScene,
              ),
...
class _CompletedLetter extends StatefulWidget {
  const _CompletedLetter({required this.letter, required this.strokes});
