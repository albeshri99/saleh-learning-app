...
/// التقييم عبر SpeechService (محاكاة حاليًا) ثم تغذية راجعة من صالح.
...
class _PronunciationSceneState extends ConsumerState<PronunciationScene> {
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      fit: StackFit.expand,
      children: [
        // مركز الحرف مرتبط بمركز مساحة السبورة نفسها، وليس بمركز الجزء
        // المتبقي فوق أدوات الميكروفون؛ لذلك لا يرتفع إلى وسم عنوان المشهد.
        Center(
          child: FittedBox(
                ...
                if (_state == _MicState.tryAgain)
                  Padding(
                    ...
                    child: Text(
                      'لنحاول مرة أخرى!',
                      style:
                          AppTypography.title.copyWith(color: AppColors.danger),
                    ),
                  ),
                _MicButton(
